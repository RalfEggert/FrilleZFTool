...
class Module implements ConsoleUsageProviderInterface, AutoloaderProviderInterface, ConfigProviderInterface
{
    ...
    public function getConsoleUsage(ConsoleAdapterInterface $console)
    {
        ...
        return array(
            ...
            'Module creation:',
            'create module <moduleName> [<path>] [--ignore-conventions|-i]'     => 'create a module',
            ...
            'Controller creation:',
            'create controller <controllerName> <moduleName> [<path>] [--ignore-conventions|-i] [--no-config|-n]' => 'create a controller in module',
            ...
            'Action creation:',
            'create action <actionName> <controllerName> <moduleName> [<path>] [--ignore-conventions|-i]' => 'create an action in a controller',
